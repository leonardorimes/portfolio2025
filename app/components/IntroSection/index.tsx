  ...
  return (
    <Container>
      <TextBlock>
        ...
        <Paragraph>
          Ao longo da minha carreira, atuei em projetos para startups e empresas
          de diferentes setores, incluindo construção civil, mercado
        ...
        <Paragraph>
          ...
          moderno e robusto que utilizo para desenvolver aplicações completas no
          lado do servidor e do cliente.
        </Paragraph>
        ...
        <Paragraph>
          ...
          <Highlight>Node.js</Highlight>, <Highlight>NestJS</Highlight> e banco
          de dados relacionais com
      ...
      <PhotoWrapper>
        ...
        {/* foto principal */}
        <Image
          src="/me.jpg" // substitua pela sua imagem
          alt="Rulian photo"
          width={340}
          height={430}
